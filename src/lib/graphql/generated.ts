...
export type ExternalIdentitySamlAttributes = {
  ...
  emails?: Maybe<UserEmailMetadata[]>
...
export type Repository = Node &
  ...
  UniformResourceLocatable & {
    ...
    contactLinks?: Maybe<RepositoryContactLink[]>
    /** Identifies the date and time when the object was created. */
    createdAt: Scalars['DateTime']
    /** Identifies the primary key from the database. */
    databaseId?: Maybe<Scalars['Int']>
    ...
    issueTemplates?: Maybe<IssueTemplate[]>
    ...
    pullRequestTemplates?: Maybe<PullRequestTemplate[]>
      ...
      repositories: { __typename: 'RepositoryConnection' } & {
        edges?: Maybe<
          Array<
            Maybe<
              { __typename: 'RepositoryEdge' } & {
                node?: Maybe<{ __typename: 'Repository' } & Pick<Repository, 'id' | 'name'>>
              }
            >
          >
        >
...
export type RepositoryFragment = { __typename: 'Repository' } & Pick<
  Repository,
  'id' | 'name' | 'stargazerCount' | 'description'
>
...
export type RepositoryQuery = { __typename: 'Query' } & {
  user?: Maybe<{ __typename: 'User' } & { repository?: Maybe<{ __typename: 'Repository' } & RepositoryFragment> }>
}
